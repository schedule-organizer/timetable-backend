...
## Acceptance Criteria
- [x] Maven project compiles with Java 21 source/target
- [x] Spring Boot 3 application starts successfully
- [x] Dependencies included: Spring Web, Spring Security, Spring Data JPA, Spring Validation, Spring Actuator, MapStruct, Springdoc OpenAPI
